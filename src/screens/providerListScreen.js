...
export default function ProviderListScreen(props){

    console.log('------------------------------------------------------------------------------------------------------------')
    console.log('------------------------------------------------------------------------------------------------------------')
    console.log('ProviderListScreen called')
    console.log('------------------------------------------------------------------------------------------------------------')
    const providers = Api.Provider.listProvidersByLocationID(props.locationID)
    const providerList = providers.data.listProvider ? providers.data.listProvider.items :[]
    console.log(props.locationID)
    console.log(providerList)

    const goProviderInfo = (ID, SORTKEY) => {
        passProps = {
        ...
        Navigator.pushScreen(props.componentId, ScreenConst.SCREEN_LOCATION_PROVIDER_INFO, passProps)
    }


    return(
        // <View>
        //     <Text>ProviderListScreen</Text>
        // </View>
        <View style={travutStyle.common.container.mainContainer}>
            ...
            <View style={travutStyle.common.container.midBodyContainer}>
                <ScrollView style={{width:"100%"}}>
                    {
                        providerList.map((contact,i) => {
                            return(
                                <ProviderCard
                                    key={i}
                                    // screenHeight={screenHeight}
                                    goProviderInfo={() => goProviderInfo(contact.ID, contact.SORTKEY)}
                                    data={contact}
